                      ...
                      <td align="center" style="padding: 20px 0;">
                        <table cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                          ...
                          <tr>
                            <td align="center" bgcolor="#667eea" style="border-radius: 8px;">
                              <!--[if mso]>
                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${meetingDetails.meeting_url}" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="16%" stroke="f" fillcolor="#667eea">
                                <w:anchorlock/>
                                <center>
                              <![endif]-->
